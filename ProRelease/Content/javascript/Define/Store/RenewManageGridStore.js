Ext.create('Ext.data.Store', {
    model: 'chl.Model.RenewManageGridModel',
    storeId: 'RenewManageGridStoreId',
    ...
    proxy: {
        type: 'ajax',
        api: GlobalConfig.Controllers.RenewManageGrid,
        filterParam: 'filter',
        sortParam: 'sort',
        directionParam: 'dir',
        limitParam: 'limit',
        ...
        extraParams: {
            req: 'dataset',
            dataname: 'RenewManageGrid',             //dataset名称，根据实际情况设置,数据库名
            restype: 'json',
