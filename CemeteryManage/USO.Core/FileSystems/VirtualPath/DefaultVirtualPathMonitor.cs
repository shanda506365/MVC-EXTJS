...
namespace USO.Core.FileSystems.VirtualPath
{
    ...
    public class DefaultVirtualPathMonitor : IVirtualPathMonitor
    {
        ...
        public DefaultVirtualPathMonitor(IClock clock, ILoggerFactory loggerFactory)
        {
            _clock = clock;
        ...
        public IVolatileToken WhenPathChanges(string virtualPath)
        {
            ...
            catch (HttpException e)
            {
                ...
                Logger.Warn(e, "Error monitor file changes on virtual path '{0}'", virtualPath);
