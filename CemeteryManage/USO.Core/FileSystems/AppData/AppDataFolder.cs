...
namespace USO.Core.FileSystems.AppData
{
    using System;
    ...
    using USO.Core.FileSystems.VirtualPath;
    using USO.Core.Logging;
    using USO.Core.Validation;
    ...
    public class AppDataFolder : IAppDataFolder
    {
        ...
        private void MakeDestinationFileNameAvailable(string destinationFileName)
        {
            ...
            {
                _logger.Warn("Could not delete recipe execution folder {0} under \"App_Data\" folder", destinationFileName);
                return;
            }
            ...
            {
                throw new Exception(string.Format("Unable to make room for file \"{0}\" in \"App_Data\" folder", destinationFileName), e);
            }
        }
        ...
        {
            _logger.Info("Storing file \"{0}\" as \"{1}\" in \"App_Data\" folder", sourceFileName, destinationPath);
        ...
        {
            _logger.Info("Deleting file \"{0}\" from \"App_Data\" folder", path);
